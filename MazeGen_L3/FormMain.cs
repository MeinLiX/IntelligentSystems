...
public partial class FormMain : Form
{
    ...
    private void Button_generate_Click(object sender, EventArgs e)
    {
        ...
        if (CellWidth < 20 || CellHeight < 20) CellWidth = CellHeight = 20;
        ...
        Bm.Dispose();
        Bm = new(CellWidth * (Mz.Finish.X + 2), CellHeight * (Mz.Finish.Y + 2), System.Drawing.Imaging.PixelFormat.Format16bppRgb555);
